...
public class StatusGetter {
    ...
    private static final int HTTP_CLIENT_REQUEST_TIMEOUT_MINUTES = 2;
    private static final String HTTP_CLIENT_URI = "https://www.cmteb.ro/functionare_sistem_termoficare.php";
